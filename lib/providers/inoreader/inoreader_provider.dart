...
class InoreaderProvider implements FeedProvider {
  String? _apiKey;
  String? _baseUrl;
  ...
  String get _baseUrlResolved => _baseUrl ?? 'https://www.inoreader.com/reader/api/0';

  Map<String, String> get _headers => {
    'Authorization': 'GoogleLogin auth=$_apiKey',
    'Accept': 'application/json',
  };

  @override
  String get providerId => 'inoreader';

  @override
  String get displayName => 'Inoreader';

  @override
  String get defaultBaseUrl => 'https://www.inoreader.com/reader/api/0';
  ...
  Future<AuthResult> authenticate(Object config) async {
    try {
      ...
      final testUrl = Uri.parse('$_baseUrlResolved/user-info?n=1');
      final response = await http.get(
        testUrl,
        headers: {
          'Authorization': 'GoogleLogin auth=${apiKeyConfig.apiKey}',
          'Accept': 'application/json',
        },
      );
      ...
      if (response.statusCode == 200) {
        ...
        return AuthResult(
          success: true,
          config: _config,
          userId: apiKeyConfig.apiKey,
        );
      }
      return AuthResult(success: false, error: 'API key inválida');
    } catch (e) {
  ...
  Future<OpmlImportResult> importOpml(String opmlContent) async {
    try {
      ...
      request.headers['Authorization'] = 'GoogleLogin auth=$_apiKey';
      request.files.add(
